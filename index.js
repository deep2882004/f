...
ScrollReveal({ 
  ...
  ScrollReveal().reveal('.middle-text', { delay: 300,origin:'bottom', interval: 200 });

  ScrollReveal().reveal('.text', { delay: 300,origin:'bottom', interval: 200 });
  ScrollReveal().reveal('.car-inforamtion-container', { delay: 300,origin:'top',});

  ScrollReveal().reveal('.grid-image1', { delay: 200,origin:'top',});
  ScrollReveal().reveal('.grid-image2', { delay: 200,origin:'bottom',});
  ScrollReveal().reveal('.grid-image3', { delay: 200,origin:'bottom',});
...
function playNextVideo() {
   ...
   document.querySelector('.all-videos').style.transform = `translateX(-${100 * currentIndex}vw)`;
...
const textss = [
 ...
 {
   title: "tailor made ferrari <br> roma spider: refined <br> and elegent <br> techniques bring an <br> innovative car to life",
   paragraph: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing.",
